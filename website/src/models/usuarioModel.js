...
function autenticar(email, senha) {
    ...
    var instrucao = `
        SELECT idFuncionario, nome, email, fkIndustria FROM funcionario WHERE email = '${email}' AND senha = '${senha}';
    `;
...
function cadastrarFuncionario(nome, email, senha, fkEmpresa) {
    ...
    //  e na ordem de inserção dos dados.
    var instrucao = `
        INSERT INTO funcionario (nome, email, senha, fkIndustria, funcao) VALUES ('${nome}', '${email}', '${senha}', ${fkEmpresa}, 'Admin');
    `;
    console.log("Executando a instrução SQL: \n" + instrucao);
    return database.executar(instrucao);
}
